<template>
  ...
  <el-button class="del-batch" type="danger" icon="el-icon-delete" @click="delArticleBatch">批量完全删除</el-button>
  <el-button class="del-batch" type="success" icon="el-icon-delete" @click="recoveryArticleBatch">批量恢复至草稿箱</el-button>
